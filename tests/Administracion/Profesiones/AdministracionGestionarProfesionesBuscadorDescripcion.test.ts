...
test('@Gestionar @Regression (IDGS-41) Verificar que al ingresar datos validos en el buscador Descripcion en Profesiones funciona correctamente', async ({gestionarProfesionesBuscadorDescripcion}) => {
