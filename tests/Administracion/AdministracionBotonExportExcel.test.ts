...
test('@Administracion @Regression (IDGS-35) Verificar que al clickear el boton EXPORTAR a Excel en Capacitaciones funciona correctamente', async ({administracionGestionarCapacitaciones}) => {
...
test('@Administracion @Regression (IDGS-37) Verificar que al clickear el boton EXPORTAR a Excel en Intereses funciona correctamente', async ({administracionGestionarIntereses}) => {
...
test('@Administracion @Regression (IDGS-40) Verificar que al clickear el boton EXPORTAR a Excel en Enfermedades funciona correctamente', async ({administracionGestionarEnfermedades}) => {
...
test('@Administracion @Regression (IDGS-43) Verificar que al clickear el boton EXPORTAR Excel en Profesiones funciona correctamente', async ({administracionGestionarProfesiones}) => {
...
test('@Administracion @Regression (IDGS-46) Verificar que al clickear el boton EXPORTAR a Excel en Discapacidades funciona correctamente', async ({administracionGestionarDiscapacidades}) => {
...
test('@Administracion @Regression (IDGS-49) Verificar que al clickear el boton EXPORTAR a Excel en Estado Civil funciona correctamente', async ({administracionGestionarEstadoCivil}) => {
...
test('@Administracion @Regression (IDGS-52) Verificar que al clickear el boton EXPORTAR a Excel en Estado Civil funciona correctamente', async ({administracionGestionarTiposDeCarnet}) => {
...
test('@Administracion @Regression (IDGS-55) Verificar que al clickear el boton EXPORTAR a Excel en Niveles de Idioma funciona correctamente', async ({administracionGestionarNivelesIdioma}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Niveles de Estudio funciona correctamente', async ({administracionGestionarNivelEstudio}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Niveles de Informatica funciona correctamente', async ({administracionGestionarNivelesInformatica}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Idiomas funciona correctamente', async ({administracionGestionarIdiomas}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton  EXPORTAR a Excel en Disponibilidad Horaria funciona correctamente', async ({administracionGestionarDisponibilidadHoraria}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton  EXPORTAR a Excel en Sexo funciona correctamente', async ({administracionGestionarSexo}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Estados de Estudios funciona correctamente', async ({administracionGestionarEstadosEstudios}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Nacionalidades funciona correctamente', async ({administracionGestionarNacionalidades}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Titulos funciona correctamente', async ({administracionGestionarTitulos}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Vinculos Familiares funciona correctamente', async ({administracionGestionarVinculosFamiliares}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Estados de Beneficiario funciona correctamente', async ({administracionGestionarEstadosBeneficiario}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Cargos funciona correctamente', async ({administracionGestionarCargos}) => {
...
test('@Administracion @Regression (IDGS-54) Verificar que al clickear el boton EXPORTAR a Excel en Presencia funciona correctamente', async ({administracionGestionarPresencia}) => {
