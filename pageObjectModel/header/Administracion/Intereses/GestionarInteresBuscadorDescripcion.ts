...
export class GestionarInteresBuscadorDescripcion extends BasePage {
    ...
    constructor(page: Page, context: BrowserContext, environment: string) {
        ...
        this.BUSCADOR_DESCRIPCION = this.page.locator("(//textarea[@id='vINTERESDESCRIPCION'])[1]")

    }
    async ingresoBuscadorDescripcion(): Promise<void> {
        const charArray = ['ADMIN', 'ARTES', 'CARP', 'INFO', 'FOTO', 'ELECT', '!"#$%&/()=?¡¿/*-+']
        const input = "(//textarea[@id='vINTERESDESCRIPCION'])[1]"
    ...
    async navegarGestionarInteresBuscadorDescripcion(): Promise<void> {
