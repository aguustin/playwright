...
export class GestionarDisponibilidadHorariaBuscadorDescripcion extends BasePage {
    ...
    async navegarGestionarDisponibilidadHorariaBuscadorDescripcion(): Promise<void> {
